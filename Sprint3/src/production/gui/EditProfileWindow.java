...
public class EditProfileWindow extends JDialog{
	...
	public EditProfileWindow(JFrame parent, UserAccount currentAccount, UserAccountManager accountManager) {
		super(parent, currentAccount==null? "Crear nueva cuenta": "Editar cuenta actual");
	...
	void confirmButtonHandler(ActionEvent e) {
		...
		if(accountActionResult.equals(UserAccountManager.NOINPUTERROR)) 
    		JOptionPane.showMessageDialog(this, "Nueva cuenta creada!", "Registro de usuario exitoso", JOptionPane.INFORMATION_MESSAGE);
		else
			JOptionPane.showMessageDialog(this, "Nueva cuenta no creada!", "Registro de usuario fallido", JOptionPane.INFORMATION_MESSAGE);
