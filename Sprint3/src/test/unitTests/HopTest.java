...
public class HopTest {
    ...
    public void BlacktestValidHop() {
        ...
        Assert.assertTrue("Captura Invalida", game.validMove(5, 0, 3, 2));
    }
    ...
    public void RedtestValidHop() {
        ...
        game.changeTurn();
        Assert.assertTrue("Captura Invalida", game.validMove(2, 1, 4, 3));
    }

    @Test
    public void BlacktestInvalidHop() {
        game.makeMove(5,2,4,1);
        Assert.assertFalse("Captura Invalida", game.validMove(5, 0, 3, 2));
    }

    @Test
    public void RedtestInvalidHop() {
        game.makeMove(2,3,3,2);
        Assert.assertFalse("Captura Invalida", game.validMove(2, 1, 4, 3));
    }
