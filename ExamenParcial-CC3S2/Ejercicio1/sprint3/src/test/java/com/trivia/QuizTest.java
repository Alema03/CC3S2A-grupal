...
public class QuizTest {
    ...
    public void testQuestionDifficulty() {
        assertEquals(Difficulty.FACIL, question1.getDifficulty(), "La dificultad de la pregunta 1 no es correcta.");
        assertEquals(Difficulty.MEDIO, question2.getDifficulty(), "La dificultad de la pregunta 2 no es correcta.");
    }

    @Test
    public void testDetailedResults() {
        quiz.setTotalRounds(2);
        quiz.start();
